...
from binary_structs.utils.binary_field.binary_field import PrimitiveTypeField, Endianness
...
if __byteorder == 'little':
    from binary_structs.utils.binary_field.base_fields import le_int8_t    as int8_t
    from binary_structs.utils.binary_field.base_fields import le_uint8_t   as uint8_t
    ...
    from binary_structs.utils.binary_field.base_fields import be_int8_t    as int8_t
    from binary_structs.utils.binary_field.base_fields import be_uint8_t   as uint8_t
